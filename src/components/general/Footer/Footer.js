        ...
        <footer className="footer">
            <div className="container">
                ...
                <div className="footer__redes">
                    <Link className="footer__social" to="https://www.instagram.com/milobakeryba/" target="_blank">Instagram</Link>
                    <Link className="footer__social" to="https://www.facebook.com/milobakeryba-101786898209739"  target="_blank">Facebook</Link>
                </div>
